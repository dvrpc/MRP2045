...
var layer1icon = L.OpenFreightMarkers.icon({
    ...
    layer0icon = L.OpenFreightMarkers.icon({
        layer:'layer0', titleicon:'<style="background-color:#24527F; display: inline-block; height: 5px;margin-right: 5px;width: 40px;">',title: '<span2 id="legend-icon" style="background-color: #24527F"></span2> Overlay',legendMarker: 'checkbox'})
      ;
