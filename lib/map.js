...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/11/query?where=1=1&outFields=*&outSR=4326&f=geojson", function (data) {
   // console.log(data);
    layer1.addData(data);
});
...
$.getJSON("data/pt_rd_sp.js", function (data) {
...
$.getJSON("data/pt_tr_sp.js", function (data) {
