...
var oLat = 40.018, oLng = -75.148, zLevel = 9;             ///adjust lat-lon coordinates to center on your region
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/DVRPC_Boundaries/FeatureServer/1/query?where=DVRPC_REG%3D%27Yes%27&outFields=STATE%20+CO_NAME&geometryPrecision=5&outSR=4326&f=pgeojson", function (data) {
    DVRPC.addData(data);
});
DVRPC.addTo(map);
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/11/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
   // console.log(data);
    layer1.addData(data);
});
...
var layer3pt = L.geoJson(null, {
    ...
    onEachFeature: function (feature, layer){           
        layer.on({                                          
            click: highlightLayer3pt,                 //click function handling specific to data type (one for point and one for polygon) --> created in actions.js                               
            dblclick: zoomToPoint                               
        });
    //     layer3Search.push({                                //push variables from json features to search arrays
    //        name: layer.feature.properties.FACILITY_1,      //search name/field
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/3/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/10/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/12/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
    layer4.addData(data);
});
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/14/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
    layer5.addData(data);
});
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/0/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/7/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/9/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
    layer6.addData(data);
});
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/8/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {
    layer7.addData(data);
});
polyLayer.push('layer7');
...
$.getJSON("https://services1.arcgis.com/LWtWv6q6BJyKidj8/arcgis/rest/services/MRP2045/FeatureServer/13/query?where=1=1&outFields=*&outSR=4326&f=pgeojson", function (data) {     //get data from json source
    layer8.addData(data);
});
