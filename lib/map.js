...
var layer1icon = L.OpenFreightMarkers.icon({
    ...
    layer0icon = L.OpenFreightMarkers.icon({
        layer:'layer0', titleicon:'<style="background-color:#ff5733; display: inline-block; height: 5px;margin-right: 5px;width: 40px;">',title: '<span2 id="legend-icon" style="background-color: #ff5733"></span2> NJ Congressional',legendMarker: 'checkbox'})
    layer9icon = L.OpenFreightMarkers.icon({
        layer:'layer9', titleicon:'<style="background-color:#301934; display: inline-block; height: 5px;margin-right: 5px;width: 40px;">',title: '<span2 id="legend-icon" style="background-color: #301934"></span2> NJ State Legislative',legendMarker: 'checkbox'})
    layer10icon = L.OpenFreightMarkers.icon({
        layer:'layer10', titleicon:'<style="background-color:#FFC300 ; display: inline-block; height: 5px;margin-right: 5px;width: 40px;">',title: '<span2 id="legend-icon" style="background-color: #FFC300 "></span2> PA Congressional',legendMarker: 'checkbox'})
    layer11icon = L.OpenFreightMarkers.icon({
        layer:'layer11', titleicon:'<style="background-color:#fa0048 ; display: inline-block; height: 5px;margin-right: 5px;width: 40px;">',title: '<span2 id="legend-icon" style="background-color: #fa0048  "></span2> PA State House',legendMarker: 'checkbox'})   
      layer12icon = L.OpenFreightMarkers.icon({
        layer:'layer12', titleicon:'<style="background-color:#b200fa  ; display: inline-block; height: 5px;margin-right: 5px;width: 40px;">',title: '<span2 id="legend-icon" style="background-color: #b200fa   "></span2> PA State Senate',legendMarker: 'checkbox'})
    ...
    DVRPC.addTo(map);
// Add Political Layers 
    function highlightFeatureNJC(e) {
        var layer = e.target;
    ...
    function resetHighlightNJC(e) {
        layer0.resetStyle(e.target);
    }

    //NJ Congressional
    var layer0 = L.geoJson(null, {
      //  style: {stroke:true, fillColor:'none',color: '#636363',weight: 3,fill: true, clickable: false}
      style: {stroke:true, fillColor:'#ffe8e4',color: '#f72c00', weight: 3,fill: true, clickable: true},  
         onEachFeature: function (feature, layer){  
                layer.bindLabel('District - '+feature.properties.district, { noHide: true, direction: "auto", className: "leaflet-label-NJC" });                      
                layer.on({
                mouseover: highlightFeatureNJC,
                mouseout: resetHighlightNJC
               // click: highlightLayer1
            });
            }
            
    });
    $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Boundaries/NJ_Congressional/FeatureServer/0/query?where=1=1&outFields=*&outSR=4326&f=geojson", function (data) {
        layer0.addData(data);
    });
    polyLayer.push('layer0');

    function highlightFeatureNJSL(e) {
        var layer = e.target;
    ...
    function resetHighlightNJSL(e) {
        layer9.resetStyle(e.target);
    }

    //NJ State Leg
    var layer9 = L.geoJson(null, {
      //  style: {stroke:true, fillColor:'none',color: '#636363',weight: 3,fill: true, clickable: false}
      style: {stroke:true, fillColor:'#ffe8e4',color: '#301934', weight: 3,fill: true, clickable: true},  
         onEachFeature: function (feature, layer){  
                layer.bindLabel('District - '+feature.properties.district, { noHide: true, direction: "auto", className: "leaflet-label-NJSL" });                      
                layer.on({
                mouseover: highlightFeatureNJSL,
                mouseout: resetHighlightNJSL
               // click: highlightLayer1
            });
            }
            
    });
    $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Boundaries/NJ_State_Legislative/FeatureServer/0/query?where=1=1&outFields=*&outSR=4326&f=geojson", function (data) {
        layer9.addData(data);
    });
    polyLayer.push('layer9');

    function highlightFeaturePAC(e) {
        var layer = e.target;
    ...
    function resetHighlightPAC(e) {
        layer10.resetStyle(e.target);
    }

    //NJ State Leg
    var layer10 = L.geoJson(null, {
      //  style: {stroke:true, fillColor:'none',color: '#636363',weight: 3,fill: true, clickable: false}
      style: {stroke:true, fillColor:'#FFC300 ',color: '#FFC300', weight: 3,fill: true, clickable: true},  
         onEachFeature: function (feature, layer){  
                layer.bindLabel('District - '+feature.properties.leg_distri, { noHide: true, direction: "auto", className: "leaflet-label-PAC" });                      
                layer.on({
                mouseover: highlightFeaturePAC,
                mouseout: resetHighlightPAC
               // click: highlightLayer1
            });
            }
            
    });
    $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Boundaries/PA_Congressional/FeatureServer/0/query?where=1=1&outFields=*&outSR=4326&f=geojson", function (data) {
        layer10.addData(data);
    });
    polyLayer.push('layer10');

    function highlightFeaturePASH(e) {
        var layer = e.target;
    ...
    function resetHighlightPASH(e) {
        layer11.resetStyle(e.target);
    }

    //NJ State Leg
    var layer11 = L.geoJson(null, {
      //  style: {stroke:true, fillColor:'none',color: '#636363',weight: 3,fill: true, clickable: false}
      style: {stroke:true, fillColor:'#fa0048',color: '#fa0048', weight: 3,fill: true, clickable: true},  
         onEachFeature: function (feature, layer){  
                layer.bindLabel('District - '+feature.properties.leg_distri, { noHide: true, direction: "auto", className: "leaflet-label-PASH" });                      
                layer.on({
                mouseover: highlightFeaturePASH,
                mouseout: resetHighlightPASH
               // click: highlightLayer1
            });
            }
            
    });
    $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Boundaries/PA_State_House/FeatureServer/0/query?where=1=1&outFields=*&outSR=4326&f=geojson", function (data) {
        layer11.addData(data);
    });
    polyLayer.push('layer11');

    function highlightFeaturePASS(e) {
        var layer = e.target;
    ...
    function resetHighlightPASS(e) {
        layer12.resetStyle(e.target);
    }

    //NJ State Leg
    var layer12 = L.geoJson(null, {
      //  style: {stroke:true, fillColor:'none',color: '#636363',weight: 3,fill: true, clickable: false}
      style: {stroke:true, fillColor:'#b200fa',color: '#b200fa', weight: 3,fill: true, clickable: true},  
         onEachFeature: function (feature, layer){  
                layer.bindLabel('District - '+feature.properties.leg_distri, { noHide: true, direction: "auto", className: "leaflet-label-PASS" });                      
                layer.on({
                mouseover: highlightFeaturePASS,
                mouseout: resetHighlightPASS
               // click: highlightLayer1
            });
            }
            
    });
    $.getJSON("https://arcgis.dvrpc.org/portal/rest/services/Boundaries/PA_State_Senate/FeatureServer/0/query?where=1=1&outFields=*&outSR=4326&f=geojson", function (data) {
        layer12.addData(data);
    });
    polyLayer.push('layer12');
