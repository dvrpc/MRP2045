...
var layer1 = L.geoJson(null, {
    ...
    onEachFeature: function (feature, layer){  
        ...
        layer1Search.push({
            name: layer.feature.properties.FACILITY_1,
            source: "Layer 1",
            id: L.stamp(layer),
...
$.getJSON("data/rd_se.js", function (data) {
    layer1.addData(data);
});
...
var layer3pt = L.geoJson(null, {
    pointToLayer: function (feature, latlng) {
       return L.circleMarker(latlng, geojsonMarker1Options).bindLabel(feature.properties.FACILITY_1, { className: 'leaflet-label-RSEF'  });;
        },
    onEachFeature: function (feature, layer){           
        layer.on({                                          
...
$.getJSON("data/RSP.js", function (data) {
...
$.getJSON("data/rd_sp.js", function (data) {
...
$.getJSON("data/rd_op.js", function (data) {
    layer4.addData(data);
});
...
$.getJSON("data/TSP.js", function (data) {
...
$.getJSON("data/tr_sp.js", function (data) {
...
$.getJSON("data/tr_op.js", function (data) {
    layer6.addData(data);
});
...
$.getJSON("data/tr_se.js", function (data) {
    layer7.addData(data);
});
...
var layer8 = L.geoJson(null, {
  ...
  style: function(feature) {
                    ...
                    case 'External Unfunded':   return {color: "#a1864c", weight: 4,opacity: .8,};
                    }
                    },  
    onEachFeature: function (feature, layer){       //defines actions to be applied of each feature of layer
          layer.bindLabel(feature.properties.FACILITY_1, { noHide: true, direction: "auto", className: "leaflet-label-EXT" }); 
        layer.on({                                      //Event handler on each feature
...
$.getJSON("data/ext.js", function (data) {     //get data from json source
    layer8.addData(data);
});
...
$(document).one("ajaxStop", function() {
   ...
   //initialize 
    ...
    $("#searchbox").typeahead({
        ...
        templates: {
            header: "<h5 class='typeahead-header'>Externall Funded</h5>"
        }
