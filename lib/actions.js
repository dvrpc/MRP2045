...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Federal and State Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Federal New Starts / <br>Small Starts<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2017 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.PreCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.External_C).format('($0,0.0)') +"</td><td> "+ numeral(props.UnfundCost).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
  //  +TIP2a
