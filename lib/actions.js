...
function highlightLayer3pt(e) {
 ...
 //       else { TIP =  "<div class='datafield'>"+tips.join(', ')+"</div><div class='labelfield'>TIP Project(s)</div>"};
    ...
    if (props.TIP1a ==='0'){ var TIP1a = '';}
        else { var TIP1a = "<a class='one' href='http://www.dvrpc.org/asp/TIPsearch/" + props.TIPYEAR + "/" + props.STATE + "/Tip-Search/DetailPrintTIP.asp?projid="+props["TIP"+i] +"' target='_blank'>"+ props["TIP"+i]+"</a>"};
